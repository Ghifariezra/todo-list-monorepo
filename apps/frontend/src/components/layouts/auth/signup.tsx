...
function SignupLayout() {
	return (
		<Section id="signup">
			<motion.div className="grid sm:grid-cols-2 items-center justify-center gap-8 sm:gap-4 w-full px-6 py-8 bg-white/30 dark:bg-slate-900/30 backdrop-blur-md border border-white/20 dark:border-slate-700/20 rounded-2xl shadow-lg duration-500 ease-in">
